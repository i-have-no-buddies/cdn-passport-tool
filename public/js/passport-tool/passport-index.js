...
function generatePdf() {
  $('[id^=flush-collapse-origin]').attr(
    'class',
    'accordion-collapse collapse show'
  );
  $('[id^=flush-collapse-destination]').attr(
    'class',
    'accordion-collapse collapse show'
  );
  html2canvas($('#PdfElement')[0], {
    useCORS: true,
    allowTaint: true,
    scrollY: 0,
  }).then((canvas) => {
...
function getDetailsTour() {
  ...
  tour.addStep({
    ...
    title: 'Inputs Guide',
    text: '1. Enter a current passport here. An autocomplete will appear where you can select a country.',
    arrow: false,
    attachTo: {
  ...
  tour.addStep({
    ...
    title: 'Inputs Guide',
    text: '2. Enter a new passport here. An autocomplete will appear where you can select a country.',
    arrow: false,
    attachTo: {
    ...
    buttons: [
      {
        ...
        text: '<i class="fas fa-arrow-left"></i> Back',
        action() {
          return this.show('get-detail-tour-02');
        },
      },
      {
        text: 'Next <i class="fas fa-arrow-right"></i>',
